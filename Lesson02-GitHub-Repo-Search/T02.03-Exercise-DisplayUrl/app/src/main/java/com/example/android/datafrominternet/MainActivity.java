...
public class MainActivity extends AppCompatActivity {
    ...
    private void makeGithubSearchQuaery() {
        String typedSearch = mSearchBoxEditText.getText().toString();
        URL url = NetworkUtils.buildUrl(typedSearch);
